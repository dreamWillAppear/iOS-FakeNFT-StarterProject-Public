...
+ Реализовать отображение обложки и описания коллекции (est: 60 минут; fact: 80 минут).
+ Реализовать отображение [страницы](https://practicum.yandex.ru/ios-developer/) в UIWebView при тапе на имя автора (est: 30 минут; fact: 40 минут).
+ Реализовать загрузку информации для ячеек UICollectionView (est: 60 минут; fact: 120 минут).
+ Реализовать логику отображения рейтинга элемента коллекции (est: 60 минут; fact: 30 минут).
+ Реализовать логику добавления и удаления элемента коллекции из избранного (est: 60 минут; fact: 120 минут).
+ Реализовать логику добавления и удаления элемента коллекции из корзины (est: 60 минут; fact: 120 минут).
